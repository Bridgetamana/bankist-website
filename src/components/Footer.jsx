...
const Footer = () => {
  return (
    <footer class="bg-[#37383d] p-8 md:p-10 transition-transform duration-500">
        <div class="mx-auto max-w-screen-xl text-center">
            ...
            <span class="text-sm text-gray-400 sm:text-center">©2022 <a href="#" class="hover:underline text-gray-300">Bridget</a>. All Rights Reserved.
            </span>
        </div>
    </footer>
  )
